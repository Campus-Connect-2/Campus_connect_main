  ...
  return (
    ...
    <section className="Intro" style={{width:"100%", height:"110vh", backgroundColor:"#242424"}}>
      <div className="intro-box" style={{width:"90%", height:"80%", display:"flex", justifyContent:"space-between", overflow:"hidden" ,alignItems:"center", top:"50vh", left:"50vw", position:"absolute", transform:"translate(-50%,-50%)"}}>
        <div className="introtext" style={{width:"35vw", height:"fit-content", backgroundColor:"white", borderRadius:"15px", marginTop:"5vh", marginLeft:"1vw", padding:"4vh 4vw"}}>
...
Or
        ...
        //  backgroundColor:"#FFE8B6",
          ...
          <div className="introRightTitle" style={{display:"flex", flexDirection:"column", alignItems:"flex-end", marginBottom:"6vh"}}>
      ...
      <div className="collaboration" style={{position:"absolute", top:"100vh", left:"10vw", width:"80%", height:"fit-content",display:"flex", flexDirection:"column", justifyContent:"space-between", alignItems:"center"}}>
        ...
        <div className="collabBox" style={{fontWeight:"300",height:"15vh", width:"100%", backgroundColor:"#ECECEC", borderRadius:"15px", marginTop:"2vh", padding:"1.5vh", display:"flex", justifyContent:"space-between", alignItems:"center"}}>
          <img src='https://drive.google.com/uc?id=1t0-AhG00w_dqLIX5ChEN7oC8FuKapIkL' style={{objectFit:"cover", height:"10vh", width:"auto"}}/>
          <img src='https://drive.google.com/uc?id=1add8MzGQnx6oiHSH9ymWM15g4VZJ3mWl' style={{objectFit:"cover", height:"10vh", width:"auto"}}/>
          <img src='https://drive.google.com/uc?id=1IHErDOomEmcH87V-C-I_x3SIMFf6gjeF' style={{objectFit:"cover", height:"10vh", width:"auto"}}/>
          <img src='https://drive.google.com/uc?id=102VZsrgGuv8xpy7Fsk8u1ePpL6ldQOLV' style={{objectFit:"cover", height:"10vh", width:"auto"}}/>
          <img src='https://drive.google.com/uc?id=15-IUF2HLVGzlH658zRcGtzzMN8oXLt4M' style={{objectFit:"cover", height:"10vh", width:"auto"}}/>
          <img src='https://drive.google.com/uc?id=1BQ89StAoGOhCyr9M7hnniRP7IqIatL-k' style={{objectFit:"cover", height:"7vh", width:"auto"}}/>
          <img src='https://drive.google.com/uc?id=15Alz5cmMpJrHu4hE7ak69777WYHwEuJh' style={{objectFit:"cover", height:"10vh", width:"auto"}}/>
          <img src='https://drive.google.com/uc?id=181Ei7UiAa5O_cW7jILwjo3k2xlYxpial' style={{objectFit:"cover", height:"8vh", width:"auto"}}/>

        </div>
      </div>
    <section className="About" style={{width:"100%", height:"220vh", padding:"9vw", display:"flex", flexDirection:"column", justifyContent:"space-between", alignItems:"center"}}>
      <div className="stats" style={{width:"90%", position:"relative"}}>
        <div className="statsBox" style={{width:"100%", height:"fit-content", display:"flex", flexDirection:"column", alignItems:"center", backgroundColor:"#FFE8B6", borderRadius:"15px", boxShadow:"0px 5px 3px rgba(0, 0, 0, 0.3)"}}>
